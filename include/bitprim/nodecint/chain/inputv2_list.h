...
#ifndef BITPRIM_NODECINT_CHAIN_INPUTV2_LIST_H_
#define BITPRIM_NODECINT_CHAIN_INPUTV2_LIST_H_
...
BITPRIM_EXPORT
inputv2_list_t chain_inputv2_list_construct_default(void);
...
#endif /* BITPRIM_NODECINT_CHAIN_INPUTV2_LIST_H_ */
