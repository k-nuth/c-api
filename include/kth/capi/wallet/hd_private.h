...
KTH_EXPORT
kth_hd_private_t kth_wallet_hd_private_construct_with_prefix(kth_hd_key_t const* private_key, uint64_t prefixes);
...
KTH_EXPORT
kth_hd_private_t kth_wallet_hd_private_construct_string_with_prefix(char const* encoded, uint64_t prefixes);
