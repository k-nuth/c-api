...
bool_t kth_chain_block_is_valid(kth_block_t block) {
...
///*static*/
//uint256_t kth_chain_block_proof(uint64_t /*size_t*/ height) {
...
uint64_t /*size_t*/ kth_chain_block_total_inputs(kth_block_t block, bool_t with_coinbase=1) {
...
bool_t kth_chain_block_is_final(kth_block_t block, uint64_t /*size_t*/ height, uint32_t kth_block_time) {
    return kth::bool_to_int(chain_block_const_cpp(block).is_final(height, kth_block_time));
}
