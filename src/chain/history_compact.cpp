...
point_kind_t kth_chain_history_compact_get_point_kind(history_compact_t history) {
    return static_cast<point_kind_t>(chain_history_compact_const_cpp(history).kind);
}

kth_point_t kth_chain_history_compact_get_point(history_compact_t history) {
    return &chain_history_compact_cpp(history).point;
}

uint32_t kth_chain_history_compact_get_height(history_compact_t history) {
    return kth_chain_history_compact_const_cpp(history).height;
}

uint64_t kth_chain_history_compact_get_value_or_previous_checksum(history_compact_t history) {
