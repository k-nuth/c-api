...
KTH_CONV_DEFINE(keoken, get_assets_data_t, kth::keoken::get_assets_data, get_assets_data)

// ---------------------------------------------------------------------------
extern "C" {

// get_assets_data_t keoken_get_assets_data_construct_default(void) {
//     return new kth::keoken::get_assets_data();
// }

get_assets_data_t keoken_get_assets_data_construct(keoken_asset_id_t asset_id, char const* asset_name, kth_payment_address_t asset_creator, keoken_amount_t amount) {
...
keoken_asset_id_t keoken_get_assets_data_asset_id(get_assets_data_t obj) {
    return keoken_get_assets_data_const_cpp(obj).asset_id;
}

char const* keoken_get_assets_data_asset_name(get_assets_data_t obj) {
    auto const& asset_name = keoken_get_assets_data_const_cpp(obj).asset_name;
    return kth::create_c_str(asset_name);
}

kth_payment_address_t keoken_get_assets_data_asset_creator(get_assets_data_t obj) {
