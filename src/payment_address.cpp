...
payment_address_t payment_address_construct_from_string(const char* address){
    return std::make_unique<libbitcoin::wallet::payment_address>(std::string(address)).release();
}
